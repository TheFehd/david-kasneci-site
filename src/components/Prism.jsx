...
const Prism = ({
  ...
  useEffect(() => {
    ...
    const SAT = saturation != null ? saturation : (transparent ? 1.5 : 1);
    ...
    const dpr = 1; /* light beams don't need retina */
    ...
    const render = t => {
      if (t - lastT < 33) { raf = requestAnimationFrame(render); return; } /* 30fps cap */
      lastT = t;
